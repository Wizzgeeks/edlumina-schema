from mongoengine import Document, StringField, ReferenceField, DateTimeField, BooleanField,ListField,DictField,CASCADE,NULLIFY,IntField
...
class SubtopicInstitutionPageContent(Document):
    ...
    child_pages = ListField(ReferenceField("SubtopicInstitutionPageContent", reverse_delete_rule=NULLIFY))
    ...
    def save(self, *args, **kwargs):
        ...
        return super(SubtopicInstitutionPageContent, self).save(*args, **kwargs)
    def to_json(self):
        return {
            "id": str(self.id),
