...
class TopicInstitutionPageContent(Document):
    ...
    child_pages = ListField(ReferenceField("TopicInstitutionPageContent", reverse_delete_rule=NULLIFY))
    ...
    def save(self, *args, **kwargs):
        ...
        return super(TopicInstitutionPageContent, self).save(*args, **kwargs)
