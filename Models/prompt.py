...
class Prompt(Document):
    ...
    types=StringField(choices=['mcq','match','fillups','content','expand','update','trueorfalse','analysis','eval','personalized_quiz','feedback','personalized_content','ai_tutor','think_analysis_validation','test_chat_bot','adaptive_learning_content'],required=True)
